      ...
      <div className="flex flex-col gap-12 md:flex-row-reverse">
        ...
        <div className="flex-1 md:text-left">
          ...
          <p className="text-muted-foreground mb-6">
            With over 15 years of experience in full-stack development, I specialize in building scalable web applications using modern technologies. My expertise includes Symfony,
            API Platform, Typescript, React, Vue.js, and cloud architecture. I&apos;m passionate about creating elegant solutions to complex problems and sharing knowledge with the
            developer community.
          </p>
