    ...
    <div className='relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-6'>
      ...
      <div className='relative z-[1] max-w-screen-md text-center'>
        ...
        <p className='mt-6 text-[17px] md:text-lg'>
          Hey there! I&apos;m a John Doe, a Full Stack Developer who loves building cool and scalable web experiences.
          From crafting beautiful frontends to powering robust backends, I bring ideas to life with clean code and great
